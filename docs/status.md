...
- **Read mode** — translate any on-screen selection: a low-level mouse hook detects drag selections
  and works in Chromium/WebView2 apps (Teams/WhatsApp) via a save/restore clipboard fallback; a
  polished, RTL-aware result pop-up; a short-lived LRU translation cache.
